...
do
  case $i in
  -h|--help)
    echo "lock: Syntax: lock [-n|--no-text] [-p|--pixelate] [-f|--fastblur] [-b=VAL|--blur=VAL]"
...
if $PIXELATE ; then
  ...
  PARAMS="'$OUTPUT_IMAGE' '-scale' '10%' '-resize' '1000%' $PARAMS '$OUTPUT_IMAGE'"
else
